...
const fighterFields = {
  ...
  countering: { type: 'boolean', description: 'A counter window is open. Inspect the fighter move: Rebuttal answers melee strikes; Back of Mind answers melee strikes and projectiles. Throws bypass both.' },
...
const projectileFields = {
  ...
  style: { enum: ['blue', 'fire', 'sonic', 'citation', 'knowledge', 'mote', 'boomerang', 'rope', 'construct', 'ideaegg', 'gnat'] },
  sourceAttack: { enum: ['hadouken', 'bombardment', 'boomerang', 'lasso', 'construct', 'stream', 'volley', 'ideahatch'] },
  parentId: { type: ['integer', 'null'], description: 'Spawner id for construct-fired motes; otherwise null.' },
  state: { enum: ['traveling', 'outbound', 'returning', 'turret', 'incubating'] },
  nextFireIn: { type: ['integer', 'null'], description: 'Construct fire or Idea Hatch countdown; otherwise null.' },
  reflectable: { type: 'boolean' },
  dangerous: { type: 'boolean', description: 'False for a turret body or incubating Idea Hatch egg; their spawned projectiles are dangerous.' },
