...
const CHARS: Char[] = [
  ...
  { id: 'FLYBRAIN', brief: 'an original mutant neurologist fighter — an oversized transparent AMBER cranial dome containing a clearly visible glowing CORAL brain with CYAN synapses, two dark-teal faceted compound eyes, a small insect respirator mouthpiece, four translucent iridescent fly wings, torn white lab-coat tails over a fitted charcoal combat suit, segmented dark-teal forearm guards, acid-lime hand wraps and heavy acid-lime boots; clever and unsettling, never comedic; no readable writing, logo or text', build: 'a TALL, lean, long-limbed and agile human-fly hybrid — narrow athletic torso, quick insect-like guard, clean silhouette with all four wings readable; about 7.5 heads tall, wiry rather than bulky' },
];
...
const POSES: PoseDef[] = [
  ...
  // FLYBRAIN specials
  { name: 'ideahatch', characters: ['FLYBRAIN'], desc: 'IDEA HATCH special: crouched low and reaching both clawed hands toward a glowing translucent amber brain-egg newly placed on the floor ahead, cyan cracks beginning to form in its shell; show the full egg and fighter (this pose overrides the guard)' },
  { name: 'backmind', characters: ['FLYBRAIN'], desc: 'BACK OF MIND counter special: eerie planted guard with both claws raised while one cyan psychic afterimage of the exact body peels backward behind him, poised to vanish and punish a committed touch (this pose overrides the guard)' },
  { name: 'braindrain_1', characters: ['FLYBRAIN'], desc: 'BRAIN DRAIN FRAME 1 of 2: planted side stance with both clawed hands projecting twin cyan neural tendrils straight forward, coral sparks beginning to flow backward along them toward the cranial dome (this pose overrides the guard)' },
  { name: 'braindrain_2', characters: ['FLYBRAIN'], desc: 'BRAIN DRAIN FRAME 2 of 2: same planted siphoning stance braced harder, twin tendrils pulsing brighter as dense coral-and-cyan energy flows backward into the fiercely glowing brain dome (this pose overrides the guard)' },
];
